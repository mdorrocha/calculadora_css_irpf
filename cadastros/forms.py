...
class CalculadoraIRPFForm(forms.Form):
    vencimento_basico = forms.DecimalField(label='Informe o valor do Vencimento básico', max_digits = 10, decimal_places= 2, min_value= 0, help_text='*')
    ...
    total_dependentes = forms.IntegerField(label='Informe o total de dependentes', min_value= 0, required=False)